...
module.exports = plop => {
  plop.setGenerator('View', {
    ...
    actions: (data) => {
      ...
      let componentTemplate = data.type == "Yes" ? "./__templates__/class/classComponentRedux.js.hbs" : "./__templates__/class/classComponent.js.hbs"
  ...
  plop.setGenerator('Component', {
    ...
    actions: (data) => {
      let componentTemplate = data.type == "Class Component" ? "./__templates__/stateless/classComponent.js.hbs" : "./__templates__/stateless/statelessComponent.js.hbs"  
